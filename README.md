# An Algorithm for Passive Microwave Precipitation Retrievals: Transfer Learning from Reanalysis Data to Multi-satellite Observations using Boosted Decision Trees
